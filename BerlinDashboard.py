...
def run():
    ...
    link = '[©Developed by Engr,Felix](https://github.com/onoriode2024)'
...
historic_district_cases_df['All Berlin'] = historic_district_cases_df.select_dtypes(include='number').sum(axis=1)
print(historic_district_cases_df)
...
st.write('''
    Dashboard created by [Engr Felix](https://linkedin.com/in/mrbriit), with [Streamlit](https://www.streamlit.io).
    See the code on [Twitter(X)](https://x.com/ejuvwevwof?s=21).
